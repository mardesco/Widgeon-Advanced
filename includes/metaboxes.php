...
// as well as a bit of "how did he do that" from the options framework theme
if(is_admin() === true){
...
$prefix = 'widgeon_';
		...
		$slideshow_options = array(
			'none' => __('No slideshow', 'widgeon'),
			'uses_slideshow_1' => __('Display Slideshow 1'),
			'uses_slideshow_2' => __('Display Slideshow 2'),
			'uses_slideshow_3' => __('Display Slideshow 3')
		);

		$slideshow_options = array(
			__('No slideshow', 'widgeon') => 'none',
			__('Display Slideshow 1') => 'uses_slideshow_1',
			__('Display Slideshow 2') => 'uses_slideshow_2',
			__('Display Slideshow 3') => 'uses_slideshow_3'
		);
...
$meta_box = array(
	...
	//a default value goes under 'std' if you want one there
		...
		array(
            'name' => __('Slideshow Options', 'widgeon'),
            'desc' => __('If this page/post will display a slideshow, select it from the dropdown menu.', 'widgeon'),
			'std' => 'none',
			'type' => 'select',
